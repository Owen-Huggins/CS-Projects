...
;; Stack BuildUp
     ADD R6, R6, #-4; set up stack frame storage
      ...
      STR R5, R6, #1
      ADD R5, R6, #0
      ADD R6, R6, #-6; store registers onto stack, leave space for 4 local var
      STR R0, R6, #4
      STR R1, R6, #3
      STR R2, R6, #2
      STR R3, R6, #1
      STR R4, R6, #0
        ...
        LDR R0, R5, 4 ;; R0 = @ node 1
        LDR R0, R0, 0
        STR R0, R5, 0
        LDR R1, R5, 5 ;; R1 = @ node 2
        LDR R1, R1, 0
        STR R1, R5, -1
        ...
        LDR R0, R5, 0 ; R0 = letter1
        LDR R1, R5, -1 ; R1 = letter 2
